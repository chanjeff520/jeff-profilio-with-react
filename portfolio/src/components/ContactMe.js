...
export default function ContactMe() {
    ...
    return (
        <div>
            ...
            <div>
                <div className="w-full max-w-2xl p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto my-20">
                    <form className="space-y-6">
                        ...
                        onClick={handleOnSubmit}>Submit Message</button>
                    </form>
                </div>
            </div>
        </div>
